...
const rtwSizes: SizeOption[] = ['S', 'M', 'L', 'XL', '2X', '3X', '4X', 'Made to measure'];
...
export const shopGroups: { id: ShopGroupId; title: string; intro: string }[] = [
  { id: 'mens', title: 'Men’s clothing', intro: 'Kaftans, agbadas, suits, shirts, trousers and more. All made to order.' },
  { id: 'womens', title: 'Women’s clothing', intro: 'Kaftans, bubu and straight gowns, shirts, trousers and custom-made outfits. All made to order.' },
  { id: 'kids', title: 'Kids', intro: 'Kids’ kaftans, vest and trouser sets, and custom making. All made to order.' },
  { id: 'accessories', title: 'Accessories', intro: 'Caps, cufflinks, traditional beads, palm slippers and styling. All made to order.' },
];
...
export const shopCategories: ShopCategory[] = [
  {
    ...
    title: 'Kaftans',
    eyebrow: '01',
    intro: 'Short sleeve and long sleeve kaftans, made to order for presence, comfort and a precise personal fit.',
  ...
  },
  {
    ...
    title: 'Agbadas',
    eyebrow: '02',
    intro: 'Ceremonial 3-piece agbada sets in cloth, embroidery and presence. Made to order.',
  ...
  },
  {
    ...
    title: 'Suits',
    eyebrow: '03',
    intro: 'Political suits and business or formal suits, made to order. Tuxedos are listed beside these looks.',
    ...
    enquiryCards: [
      {
        title: 'Tuxedos',
        href: 'shop/tuxedos',
        text: 'Evening making, made to order. No tuxedo photograph is on the site yet.',
      },
    ],
  },
  {
    ...
    title: 'Tuxedos',
    eyebrow: '04',
    intro: 'Tuxedos made to order for the occasion. Message the house with the date and the image you want to carry.',
    group: 'mens',
  },
  {
    id: 'safari',
    title: 'Safari sets',
    eyebrow: '05',
    intro: 'Safari sets made to order. Message the house with cloth, colour and fit.',
    group: 'mens',
  },
  {
    id: 'shirts',
    title: 'Shirts',
    eyebrow: '06',
    intro: 'Formal, linen and African-inspired shirts, made to order. A photographed shirt look is an example in ready to wear.',
    group: 'mens',
    related: [
      {
        title: 'White tailored shirt look',
        href: 'shop/ready-to-wear/shirt-white',
        text: 'An example in ready to wear. Request as seen. The house still makes it to order.',
      },
    ],
  },
  {
    ...
    title: 'Trousers',
    eyebrow: '07',
    intro: 'Office, beltless, palazzo and regular trousers, made to order. Message the house with the cut you need.',
    group: 'mens',
  },
  {
    id: 'jackets',
    ...
    eyebrow: '08',
    intro: 'Jackets and vests, made to order. Cloth and colour are chosen with you.',
    group: 'mens',
  },
  {
    id: 'ready-to-wear',
    title: 'Ready to wear',
    eyebrow: '09',
    intro: 'Complete looks you can request as seen, including shirts, trousers and sets. The house still makes each one to order.',
  ...
  },
  {
    ...
    eyebrow: '10',
    intro: 'Custom-made outfits from an idea, a photograph, or a cloth. Made to order. Kaftans, agbadas and suits can also be bought in those departments.',
    group: 'mens',
    related: [
  ...
  },
  {
    ...
    navTitle: 'Women’s',
    eyebrow: '01',
    intro: 'Tailored two-pieces and contemporary sets, made to order. Photographs are examples. Kaftans, bubu, shirts, trousers and custom making are listed beside these looks.',
    image: '/images/looks/womens-white.jpg',
    group: 'womens',
    featured: true,
    enquiryCards: [
      { title: 'Women’s kaftans', href: 'shop/womens-kaftans', text: 'Buy a kaftan made to order.' },
      { title: 'Bubu and straight gowns', href: 'shop/bubu', text: 'Buy a gown made to order. No gown photograph is on the site yet.' },
      { title: 'Shirts', href: 'shop/womens-shirts', text: 'Women’s shirts, made to order.' },
      { title: 'Trousers and palazzo', href: 'shop/womens-trousers', text: 'Trousers and palazzo trousers, made to order.' },
      { title: 'Custom-made outfits', href: 'shop/womens-custom', text: 'Bring an idea. Made to order. The house will confirm cloth and making.' },
    ],
  },
  {
    id: 'womens-kaftans',
    ...
    eyebrow: '02',
    intro: 'Women’s kaftans, made to order. Message the house with cloth, colour and the occasion.',
    group: 'womens',
  },
  {
    id: 'bubu',
    ...
    eyebrow: '03',
    intro: 'Bubu and straight gowns, made to order. No gown photograph is on the site yet.',
    group: 'womens',
  },
  {
    id: 'womens-shirts',
    ...
    eyebrow: '04',
    intro: 'Women’s shirts, made to order.',
    group: 'womens',
  },
  {
    id: 'womens-trousers',
    ...
    eyebrow: '05',
    intro: 'Trousers and palazzo trousers, made to order. Message the house with the cut you need.',
    group: 'womens',
  },
  {
    id: 'womens-custom',
    ...
    eyebrow: '06',
    intro: 'Custom-made women’s outfits from an idea or a photograph. Made to order.',
    group: 'womens',
  },
  {
    id: 'kids-kaftans',
    title: 'Kids’ kaftans',
    eyebrow: '01',
    intro: 'Kids’ kaftans, made to order. No children’s photographs are on the site.',
    group: 'kids',
  },
  {
    id: 'kids-sets',
    ...
    eyebrow: '02',
    intro: 'Vest and trouser sets for children, made to order.',
    group: 'kids',
  },
  {
    id: 'kids-custom',
    title: 'Kids’ custom',
    eyebrow: '03',
    intro: 'Custom children’s outfits, made to order. Message the house with age, occasion and the look you have in mind.',
    group: 'kids',
  },
  {
    id: 'caps',
    title: 'Caps',
    eyebrow: '01',
    intro: 'Plain and designed caps, made to order.',
    group: 'accessories',
  },
  {
    id: 'cufflinks',
    title: 'Cufflinks',
    eyebrow: '02',
    intro: 'Cufflinks, made to order as part of styling.',
    group: 'accessories',
  },
  {
    id: 'beads',
    ...
    eyebrow: '03',
    intro: 'Traditional beads for agbada, made to order.',
    group: 'accessories',
  },
  {
    id: 'slippers',
    title: 'Palm slippers',
    eyebrow: '04',
    intro: 'Palm slippers and traditional footwear, made to order.',
    group: 'accessories',
  },
  {
    ...
    eyebrow: '05',
    intro: 'Other styling accessories, made to order. Message the house with what you need.',
    group: 'accessories',
  },
];
...
export const shopLooks: ShopLook[] = [
  {
    ...
    sleeve: 'short',
    sizes: kaftanSizes,
    description: 'A purple embroidered kaftan set with matching trousers. Request as seen. Made to order, or remade in another cloth.',
  ...
  },
  {
    ...
    description: 'An emerald ceremonial agbada with embroidery, cap and beads. Made to order.',
  ...
  },
  {
    ...
    sleeve: 'long',
    sizes: ceremonialSizes,
    description: 'A black embroidered agbada with beads. Made to order.',
  ...
  },
  {
    ...
    sleeve: 'short',
    sizes: rtwSizes,
    description: 'Short-sleeve black and white print shirt with matching trousers. Request as seen. Made to order.',
  ...
  },
  {
    ...
    sleeve: 'long',
    sizes: rtwSizes,
    description: 'White long-sleeve shirt with pink embroidered stripes and matching trousers. Request as seen. Made to order.',
  ...
  },
  {
    ...
    sleeve: 'long',
    sizes: suitSizes,
    description: 'A business or formal suit, made to order. Message the house with the occasion, cloth and the image you want to carry. The photograph shows work from the Accra atelier.',
  ...
  },
  {
    ...
    sleeve: 'long',
    sizes: suitSizes,
    description: 'Political suits, made to order. Cloth and colour are chosen with you before making begins.',
